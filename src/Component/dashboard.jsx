...
export default function Dashboard() {
  ...
  // ===== NEW: Prepare data for Pie Chart based on transaction methods =====
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="flex items-center gap-2 bg-gray-200 text-black text-sm font-semibold w-32 px-4 py-1.5 rounded-md hover:bg-gray-400 transition"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gray-200 text-black text-sm font-semibold w-36 px-4 py-1.5 rounded-md hover:bg-gray-400 transition"
            >
        ...
        <div className="flex flex-wrap gap-6 justify-center mt-6">
          {[
            ...
            <div
              key={item.title}
              className="w-52 h-32 bg-gray-50 text-gray-700 rounded-xl border border-gray-200 shadow-sm p-4"
            >
        ...
        <div className="h-[300px] mt-10 max-w-md mx-auto">
              ...
              <tbody>
                {transactions.length > 0 ? (
                  transactions.slice(0, 5).map((txn, index) => (
                    ...
                    >
                      <td className="px-4 py-3">#{txn.id || index + 1}</td>
